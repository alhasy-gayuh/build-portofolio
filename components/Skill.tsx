  ...
  return (
    <div className="group relative flex cursor-pointer">
      <motion.div
        ...
        className="filter group-hover:grayscale transition duration-300 ease-in-out rounded-full border border-gray-500 object-cover w-24 h-24 md:w-28 md:h-28 xl:w-32 xl:h-32">
        <Image
          src="/img/react.png"
          alt="logo"
          width={128}
